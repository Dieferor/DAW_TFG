...
?>
        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    ...
                    <i class="fa fa-dashboard"></i> Bandeja de entrada / Editar perfil de Admin
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        ...
                        <i class="fa fa-money fa-fw"></i> Editar perfil de Admin
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="submit" name="update" value="Actualizar Admin" class="btn btn-primary form-control">
    ...
    if (isset($_POST['update'])) {
        ...
        $update_admin = "update admins set admin_name='$admin_name',admin_email='$admin_email',admin_pass='$admin_pass' where admin_id='$admin_id'";
